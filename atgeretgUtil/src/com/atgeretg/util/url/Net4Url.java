...
import com.atgeretg.util.encode.EncodeUtil;
...
//		System.out.println(netGet(path2, null, headers));
    ...
    /**
     * URL POST请求发送，json请求<br/>
     * 请求头会加上("Content-Type","application/json");
     *
     * @param urlPath 地址
     * @param param   参数
     * @param header  请求头
     * @return null | 网络数据
     */
    public static String netJsonPost(String urlPath, Map<String, Object> param, Map<String, String> header) {
        String json = null;
        if (param != null) {
        ...
        return getJsonNetData(urlPath, json, header);
    }

    /**
     * URL POST请求，可以只发一个字符串数据
     *
     * @param urlPath 地址
     * @param data    数据
     * @param header  请求头
     * @return null | 网络数据
     */
    public static String netStrPost(String urlPath, String data, Map<String, String> header) {
        return getJsonNetData(urlPath, data, header);
    }
     ...
     * @return
     */
    private static String getJsonNetData(String urlPath, String json, Map<String, String> header) {
